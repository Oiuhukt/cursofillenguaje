...
\begin{itemize}
  ...
  \begin{itemize}
    \item \textbf{Clase 1}
    \item Gottlob Frege, “Sobre sentido y referencia”, (pp. 29-35  Donde termina el párrafo con ...referencia)
    \item \textbf{Clase 2}
    \item Gottlob Frege, “Sobre sentido y referencia”, (pp. 35-49.)
    \item \textbf{Clase 3}
    \item Bertrand Russell, `Descripciones', (pp. )
\end{itemize}
    \end{itemize}

\textbf{Actividad sugerida}
Crear un glosario con al menos algunas de las siguientes palabras: relación, igualdad, conocimiento efectivo, sentido, referencia, nombre propio, sentido indirecto, representación, conidcional subjuntivo, condición \textit{salva veritate}, lenguaje lógicamente perfecto,
...
%com- pletamente libre por lo demás el lenguaje simbólico del análisi;
